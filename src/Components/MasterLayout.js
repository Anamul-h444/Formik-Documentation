          ...
          <div>
            <div className="nav-list">
              <Link to="/" className=" nav-link">
                ...
                <span className=" nav-link-name">Nested & Field Array </span>
              </Link>

              <Link to="/ItemTwoPage" className="nav-link">
                <FaUserEdit className="nav-logo-icon" />
                <span className="nav-link-name"> API Calling</span>
              </Link>

              <Link to="/LoginForm" className="nav-link">
                <FaTasks className="nav-logo-icon" />
                <span className="nav-link-name"> Login Form</span>
              </Link>

              <Link to="/RegistrationFormPage" className="nav-link">
                <GiProgression className="nav-logo-icon" />
                <span className="nav-link-name"> Registration Form</span>
              </Link>

              <Link to="/EnrollmentFormPage" className="nav-link">
                <BsUiChecks className="nav-logo-icon" />
                <span className="nav-link-name"> Enrollment Form</span>
              </Link>

              <Link to="/CompleteFormPage" className="nav-link">
